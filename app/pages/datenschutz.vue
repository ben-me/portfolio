<template>
  <div class="page-wrapper">
    <section className="wrapper">
      ...
      <p>
        <b>1.1</b>&nbsp;Wir freuen uns, dass Sie unsere Website besuchen,
      ...
      <p>
        <b>3.1</b>&nbsp;F&uuml;r das Hosting unserer Website und die
        Darstellung der Seiteninhalte nutzen wir einen Anbieter, der seine
        Leistungen selbst oder durch ausgew&auml;hlte Sub-Unternehmer
        ausschlie&szlig;lich auf Servern innerhalb der Europ&auml;ischen
        Union erbringt.
      </p>
      ...
      <p>
        Dieser Dienst erm&ouml;glicht uns, gro&szlig;e Mediendateien wie
        Grafiken, Seiteninhalte oder Skripte &uuml;ber ein Netz regional
        verteilter Server schneller auszuliefern. Die Verarbeitung erfolgt
        zur Wahrung unseres berechtigten Interesses an der Verbesserung der
        Stabilit&auml;t und Funktionalit&auml;t unserer Website gem. Art. 6
        Abs. 1 lit. f DSGVO. Wir haben mit dem Anbieter einen
      ...
      <p>
        ...
        E-Mail) werden &ndash; ausschlie&szlig;lich zum Zweck der
        Bearbeitung und Beantwortung Ihres Anliegens und nur im daf&uuml;r
      ...
      <p>
        ...
        Kontaktierung auf einen Vertrag ab, so ist zus&auml;tzliche
        Rechtsgrundlage f&uuml;r die Verarbeitung Art. 6 Abs. 1 lit. b
        DSGVO. Ihre Daten werden gel&ouml;scht, wenn sich aus den
      ...
      <p>
        ...
        cloudbasierten Buchhaltungssoftware des folgenden Anbieters: sevDesk
        GmbH, Hauptstra&szlig;e 115, 77652 Offenburg, Deutschland
      </p>

      <p>
        Der Anbieter verarbeitet Eingangs- und Ausgangsrechnungen sowie ggf.
        auch die Bankbewegungen unseres Unternehmens, um Rechnungen
        automatisch zu erfassen, zu den Transaktionen zu matchen und hieraus
        in einem teilautomatisierten Prozess die Finanzbuchhaltung zu
        erstellen.
      </p>

      <p>
        Sofern hierbei auch personenbezogene Daten verarbeitet werden,
        erfolgt die Verarbeitung auf Basis unseres berechtigten Interesses
        an einer effizienten Organisation und Dokumentation unserer
        Gesch&auml;ftsvorg&auml;nge gem&auml;&szlig; Art. 6 Abs. 1 lit. f
        DSGVO.
      </p>
      ...
      <p>
        <b>7.1</b>&nbsp;Das geltende Datenschutzrecht gew&auml;hrt Ihnen
